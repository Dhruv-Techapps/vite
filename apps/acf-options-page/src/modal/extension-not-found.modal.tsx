...
const ExtensionNotFoundModal = () => {
  ...
  return (
    <Modal
      show={extensionNotFound}
      size="lg"
      centered
      backdrop="static"
      keyboard={false}
      onHide={onHide}
      data-testid="extension-not-found-modal"
    >
      ...
      <Modal.Body className="text-center">
        <p className="mb-0">
          <Trans
            i18nKey="modal.extensionNotFound.subTitle"
            components={{ b: <b />, Badge: <span className="text-info" /> }}
        ...
        <p className="mt-5">
          ...
          version extension gets inactive and our configuration page unable to
          communicate with same. Please do refresh once and activate extension
          again if you already have extension installed.
        </p>
      </Modal.Body>
      <Modal.Footer>
