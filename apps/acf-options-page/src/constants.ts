...
export const APP_LINK = {
  ...
  DISCUSSIONS:
    'https://github.com/Dhruv-Techapps/auto-clicker-auto-fill/discussions',
};
...
export const SPONSORS = [
  {
    ...
    image:
      'https://yt3.googleusercontent.com/ytc/AL5GRJXXSNx_TgWygPPxifjLMWl6De3YVmGwHAjOfhztgVA=s176-c-k-c0x00ffffff-no-rj',
  },
];
...
const message = encodeURIComponent(
  'Fill input field or click button or link anything anywhere. easy configure in few steps and work like PRO #AutoClickerAutoFill'
);
