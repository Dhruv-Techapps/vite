  ...
  useEffect(() => {
    if (/(DEV|BETA|LOCAL)/.test(import.meta.env.VITE_PUBLIC_VARIANT || '')) {
      window.document.title = `${t('common.appName')} [${
        import.meta.env.VITE_PUBLIC_VARIANT
      }]`;
    } else {
      window.document.title = t('common.appName');
    }
    ...
    <Navbar expand="lg" as="header" className="bd-navbar" sticky="top">
      <Container fluid className="bd-gutter flex-wrap flex-lg-nowrap" as="nav">
        ...
        <Offcanvas
          ...
          responsive="lg"
          placement="end"
          className="flex-grow-1 bd-header"
        >
          <Offcanvas.Header
            closeButton
            className="px-4 pb-0"
          ...
          <Offcanvas.Body className="p-4 pt-0 p-lg-0">
            ...
            <Nav className="flex-row flex-wrap ms-md-auto" as="ul">
              <Nav.Item
                as="li"
                className="col-6 col-lg-auto d-flex align-items-center"
              >
                <iframe
                  src="https://github.com/sponsors/Dhruv-Techapps/button"
                  title="Sponsor Dhruv-Techapps"
                  height="32"
                  width="114"
              ...
              <Nav.Item as="li" className="col-6 col-lg-auto">
                <Nav.Link
                  onClick={() => dispatch(switchSettingsModal())}
                  data-testid="open-global-settings"
                >
                  <GearFill title={t('header.settings')} />
                  <small className="d-lg-none ms-2">
                    {t('header.settings')}
                  </small>
                </Nav.Link>
              </Nav.Item>
              ...
              <Nav.Item as="li" className="col-6 col-lg-auto">
                <Nav.Link onClick={toggleTheme} data-testid="switch-theme">
                  {theme !== 'light' ? (
                    <Sun title={t('header.theme.dark')} />
                  ) : (
                    <Moon title={t('header.theme.light')} />
                  )}
              ...
              <Nav.Item as="li" className="col-6 col-lg-auto">
                ...
                >
                  ...
                  <NavDropdown.Item
                    ...
                    href="https://github.com/Dhruv-Techapps/acf-i18n/discussions/4"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Add your Language
